...
namespace vehiclecontroller
{
    ...
    public class Relay16
    {
        ...
        public Relay16()
        {
            ...
            data =   new OutputPort((Cpu.Pin)FEZ_Pin.Digital.Di6, true);
            clock =  new OutputPort((Cpu.Pin)FEZ_Pin.Digital.Di6, true);
            latch =  new OutputPort((Cpu.Pin)FEZ_Pin.Digital.Di6, true);
            enable = new OutputPort((Cpu.Pin)FEZ_Pin.Digital.Di6, true);
            clear =  new OutputPort((Cpu.Pin)FEZ_Pin.Digital.Di6, true);
